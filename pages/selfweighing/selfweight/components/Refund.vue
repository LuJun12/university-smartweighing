<template>
    <div>
        <el-dialog :title="dialogTitle" top="10vh" :show-close="false" :close-on-press-escape="false" :close-on-click-modal="false" v-model="centerDialogVisible" width="1000px">
                ...
                <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
                    <el-row>
                        ...
                        <el-col :span="12">
                            ...
                            <div class="sd-md">注意：计算器仅帮助计算退款金额</div>
                            <div class="table-new">
                                <div class="top-title">
